...
# source://importmap-rails-1.1.5/lib/importmap-rails.rb:1
module Importmap; end

# source://importmap-rails-1.1.5/lib/importmap/engine.rb:7
class Importmap::Engine < ::Rails::Engine; end

# source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:1
module Importmap::ImportmapTagsHelper
  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:35
  def javascript_import_module_tag(*module_names); end

  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:44
  def javascript_importmap_module_preload_tags(importmap = T.unsafe(nil)); end

  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:21
  def javascript_importmap_shim_nonce_configuration_tag; end

  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:29
  def javascript_importmap_shim_tag(minimized: T.unsafe(nil)); end

  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:3
  def javascript_importmap_tags(entry_point = T.unsafe(nil), shim: T.unsafe(nil)); end

  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:15
  def javascript_inline_importmap_tag(importmap_json = T.unsafe(nil)); end

  # source://importmap-rails-1.1.5/app/helpers/importmap/importmap_tags_helper.rb:49
  def javascript_module_preload_tag(*paths); end
end

# source://importmap-rails-1.1.5/lib/importmap/map.rb:3
class Importmap::Map
  # @return [Map] a new instance of Map
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:8
  def initialize; end
  ...
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:75
  ...
  #   end
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:68
  def digest(resolver:); end

  # Returns the value of attribute directories.
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:4
  def directories; end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:13
  ...
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:28
  def pin(name, to: T.unsafe(nil), preload: T.unsafe(nil)); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:33
  ...
  # the different cases.
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:43
  ...
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:54
  def to_json(resolver:, cache_key: T.unsafe(nil)); end

  private

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:155
  def absolute_root_of(path); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:90
  def cache_as(name); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:98
  def clear_cache; end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:129
  def expand_directories_into(paths); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:125
  def expanded_packages_and_directories; end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:121
  def expanded_preloading_packages_and_directories; end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:151
  def find_javascript_files_in_tree(path); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:143
  def module_name_from(filename, mapping); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:147
  def module_path_from(filename, mapping); end

  # @return [Boolean]
  #
  # source://importmap-rails-1.1.5/lib/importmap/map.rb:102
  def rescuable_asset_error?(error); end

  # source://importmap-rails-1.1.5/lib/importmap/map.rb:106
  def resolve_asset_paths(paths, resolver:); end
end

# source://importmap-rails-1.1.5/lib/importmap/map.rb:6
class Importmap::Map::InvalidFile < ::StandardError; end

# source://importmap-rails-1.1.5/lib/importmap/map.rb:87
...
# source://importmap-rails-1.1.5/lib/importmap/map.rb:88
...
# source://importmap-rails-1.1.5/lib/importmap/reloader.rb:1
class Importmap::Reloader
  # source://importmap-rails-1.1.5/lib/importmap/reloader.rb:2
  def execute(*_arg0, **_arg1, &_arg2); end

  # source://importmap-rails-1.1.5/lib/importmap/reloader.rb:2
  def execute_if_updated(*_arg0, **_arg1, &_arg2); end

  # source://importmap-rails-1.1.5/lib/importmap/reloader.rb:4
  def reload!; end
  ...
  # source://importmap-rails-1.1.5/lib/importmap/reloader.rb:17
  def config; end

  # source://importmap-rails-1.1.5/lib/importmap/reloader.rb:13
  def import_map_paths; end

  # source://importmap-rails-1.1.5/lib/importmap/reloader.rb:9
  def updater; end
end

# source://importmap-rails-1.1.5/lib/importmap/version.rb:2
